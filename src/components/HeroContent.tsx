...
export default function HeroContent() {
  return (
    <section className="relative flex h-full min-h-[100svh] items-end pb-[25%] pointer-events-none text-black">
      <div className="relative mx-auto flex w-full max-w-[calc(1400px+15%)] flex-col items-center px-[7%] pointer-events-none">
        <div className="relative z-[2] col-span-11 flex w-full flex-col pt-[5.625rem] text-[clamp(2.5rem,12vw,99rem)] leading-[0.9] text-black pointer-events-none">
          {/* Desktop SVG */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1143.9 590.2"
            className="hidden relative pointer-events-none min-[849px]:block w-[85%] md:w-[75%] lg:w-full"
          >
            <defs>
              <mask id="rebel-mask">
                <rect
              ...
              <mask id="against-mask">
                <rect
                  ...
                  height="231"
                  style={{ fill: 'rgb(255, 255, 255)' }}
                  data-svg-origin="246.60000610351562 164.3000030517578"
                  transform="matrix(1,0,0,1,0,0)"
                ></rect>
              </mask>
              <mask id="boring-mask">
          ...
          <svg
            ...
            className="block relative pointer-events-none min-[849px]:hidden w-full sm:w-[80%] md:w-[85%]"
          >
          ...
          <h1 className="font-dmsans mt-6 mb-0 text-[clamp(1.1rem,4.5vw,1.35rem)] font-normal leading-snug text-black min-[500px]:max-[850px]:mb-0 min-[500px]:max-[850px]:text-1.5rem min-[769px]:absolute min-[769px]:bottom-0 min-[769px]:left-0 min-[769px]:w-full min-[769px]:max-w-[30ch] min-[769px]:translate-y-[calc(100%+1rem)] min-[769px]:leading-[1.25] min-[1100px]:right-0 min-[1100px]:left-auto min-[1100px]:w-[30%] min-[1100px]:translate-x-[20%] min-[1100px]:translate-y-0 min-[1300px]:translate-y-[-50%] max-[340px]:text-[1.1rem] max-[340px]:leading-none">
            <span
          ...
          <div
            className="absolute cursor-pointer pointer-events-auto max-[849px]:hidden 
            w-[12.25%] h-[17.5%] left-[17.45%] bottom-[10%] 
            min-[850px]:max-[1030px]:w-[9.5%] min-[850px]:max-[1030px]:h-[15%] min-[850px]:max-[1030px]:left-[12.9%] min-[850px]:max-[1030px]:bottom-[9%]
        ...
        >
          <div className="grid w-full grid-cols-[repeat(12,auto)] items-center pointer-events-none min-[600px]:flex min-[600px]:w-auto min-[600px]:justify-start min-[600px]:gap-[1.875rem]">
            <img
              ...
              alt=""
              className="shrink pr-[20px] last:pr-0 min-[600px]:pr-0"
            />
            <img
