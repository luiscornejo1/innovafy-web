...
export default function HeroContent() {
  ...
  useGSAP(() => {
    ...
    mm.add("(min-width: 849px)", () => {
      ...
      tl.fromTo('.rebelMask',
        { scaleX: 0 },
        { scaleX: 1, duration: 1.2, ease: 'power4.inOut', transformOrigin: 'left center' }
      )
        .fromTo('.againstMask',
          { scaleX: 0 },
          { scaleX: 1, duration: 1.2, ease: 'power4.inOut', transformOrigin: 'left center' },
  ...
  return (
    ...
    <section
      ref={container}
      className="relative flex h-full min-h-[100svh] items-end pb-[25%] min-[769px]:items-center min-[769px]:pb-0 pointer-events-none text-black invisible"
    >
      <div className="relative mx-auto flex w-full max-w-[calc(1400px+15%)] flex-col items-center px-[7%] pointer-events-none">
        ...
        <div className="relative z-[2] flex w-full min-[850px]:w-11/12 self-start flex-col pt-[5.625rem] text-[clamp(2.5rem,16vw,99rem)] leading-[0.9] text-black pointer-events-none">
          <svg
            ...
            className="hidden w-full relative pointer-events-none min-[849px]:block desktop-svg"
          >
            <defs>
              <mask id="rebel-mask">
                <rect className="rebelMask" x="0" y="0" width="591.4" height="166.8" style={{ fill: 'rgb(255, 255, 255)' }}></rect>
              </mask>
              <mask id="against-mask">
                <rect className="againstMask" x="246.6" y="164.3" width="897.3" height="231" style={{ fill: 'rgb(255, 255, 255)' }}></rect>
              </mask>
              <mask id="boring-mask">
                <rect className="boringMask" x="37" y="358.5" width="773.7" height="231.7" style={{ fill: 'rgb(255, 255, 255)' }}></rect>
              </mask>
            </defs>

            <g className="rebelLetters" mask="url(#rebel-mask)">
            ...
            <g className="againstLetters" mask="url(#against-mask)">
            ...
            <g className="boringLetters" mask="url(#boring-mask)">
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 345 226.9"
            className="block relative pointer-events-none min-[849px]:hidden w-full sm:w-[80%] md:w-[85%] mobile-svg"
          >
            ...
            <span className="block h-full w-full" data-fill="true">
              <span className="block h-full w-full" data-fill="true">
                <video
                  ...
                  loop
                  muted
                  className="absolute left-0 top-0 h-full w-full overflow-hidden rounded-[45%] object-cover transition-[border-radius]"
                ></video>
              </span>
            </span>
          </div>
      ...
      <div
        className="absolute bottom-[1rem] left-[7vw] z-[3] w-[calc(100%-14vw)] pointer-events-none text-black min-[500px]:left-[2.5rem] min-[500px]:w-[calc(100%-5rem)] min-[1920px]:left-1/2 min-[1920px]:max-w-[2470px] min-[1920px]:-translate-x-1/2 min-[1920px]:p-[1.625rem]"
        data-modal-hide="true"
      >
        <span className="relative inline-block w-full pointer-events-none" data-fill="false">
          <div className="grid w-full grid-cols-[repeat(12,auto)] items-center pointer-events-none min-[600px]:flex min-[600px]:w-auto min-[600px]:justify-start min-[600px]:gap-[1.875rem]">
            <img
              src="https://kota-content.b-cdn.net/app/uploads/2024/03/Digital-Agency-Network.svg"
              alt=""
              className="logo-item shrink pr-[20px] last:pr-0 min-[600px]:pr-0"
            />
            <img
