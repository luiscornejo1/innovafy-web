...
const SERVICES_DATA: ServiceItem[] = [
    {
        ...
        imgSrc: "https://kota-content.b-cdn.net/app/uploads/2023/10/Web-design-Development-479x500.jpg",
        tags: [
    ...
    },
    {
        ...
        videoSrc: "https://kota-content.b-cdn.net/app/uploads/2024/02/homepage-1.mp4",
        imgSrc: "https://kota-content.b-cdn.net/app/uploads/2023/10/Web-design-Development-479x500.jpg",
        tags: [
...
export default function ServicePanels() {
                    ...
                    gsap.fromTo(panel,
                        ...
                        },
                        {
                            ...
                            scrollTrigger: {
                                ...
                                start: () => `bottom-=${Math.round(window.innerHeight / 2)}px bottom`,
                                end: "bottom bottom",
                                scrub: true,
                            }
                        }
    ...
    return (
        <section ref={sectionRef} className="relative z-[2] w-full max-w-[100vw] py-[3.25rem] text-black min-[850px]:pt-[9.375rem] min-[850px]:pb-[50vh]">
            <div className="stacking-panel mx-auto w-full max-w-[calc(1400px+15%)] px-[7%]">
                <SectionHeading line1="NUESTROS" line2="SERVICIOS" showIcon={true} />
            </div>

            <div className="mt-[5rem] w-full md:mt-[4rem] md:mb-[10vh] min-[850px]:mb-[25vh]">
                <div className="mx-auto flex w-full max-w-[calc(1400px+15%)] flex-col px-[7%] gap-[4.25rem] min-[850px]:gap-[70vh] min-[850px]:max-[1450px]:px-[1.625rem]">
                    {SERVICES_DATA.map((service) => (
                        <div key={service.id} className="stacking-panel col-span-12 relative w-full block">
                            <div className="relative flex w-full flex-col-reverse items-center justify-between md:flex-row min-[850px]:max-[1450px]:p-[3.125rem_3.125rem_3.125rem_5vw] z-[2]">
                                <div className="relative z-[2] flex flex-col items-start gap-[1rem] max-md:pb-[0.5rem] md:w-[50%] md:gap-[1.5rem]">
                                    <h3 className="font-dmsans m-0 mb-[0.54rem] text-[2.5rem] font-normal leading-[1] tracking-[-0.02em] md:text-[clamp(2.5rem,7.1vw,6rem)]">
                                        {service.title}
                                    </h3>
                                    ...
                                    <div className="font-dmsans flex flex-wrap gap-x-[0.4rem] gap-y-[0.625rem] md:gap-[0.625rem]">
                                        {service.tags.map((tag, idx) => (
                                            <a
                                                key={idx}
                                                href={tag.href}
                                                className="rounded-[2rem] border-[2px] border-black/30 px-[10px] py-[5px] text-[0.925rem] text-black no-underline transition-colors duration-200 cursor-pointer hover:bg-black hover:text-white hover:border-black min-[850px]:border-[#e9e9e9] min-[850px]:text-[1rem]"
                                            >
                                                {tag.text}
                                            </a>
                                        ))}
                                    ...
                                    <p className="font-dmsans m-0 text-[1.125rem] md:text-[1.2rem]">
                                        {service.description}
                                    </p>

                                    <ArrowButton text="Más información" href="/servicios" variant="dark" />
                                </div>
                                ...
                                <div className="relative z-[2] aspect-square w-full overflow-hidden rounded-tr-[5rem] max-md:mb-[1.25rem] md:w-[45%] min-[850px]:rounded-tr-[12.5rem]">
                                    ...
                                    <span className="absolute left-0 top-0 hidden h-full w-full min-[769px]:flex">
                                        <video loop muted playsInline autoPlay className="absolute left-0 top-0 h-full w-full object-cover">
