...
const SERVICES_DATA: ServiceItem[] = [
    {
        ...
        imgSrc: "https://kota-content.b-cdn.net/app/uploads/2024/02/homepage-mobile.jpg",
        tags: [
    ...
    },
    {
        ...
        imgSrc: "https://kota-content.b-cdn.net/app/uploads/2024/02/homepage-1-mobile.jpg",
        tags: [
    ...
    },
    {
        ...
        imgSrc: "https://kota-content.b-cdn.net/app/uploads/2024/02/homepage-3-mobile.jpg",
        tags: [
                                ...
                                <div className="relative z-[2] flex flex-col items-start gap-[1rem] max-md:pb-[0.5rem] md:w-[50%] md:gap-[1.5rem]">
                                    ...
                                    <div className="inline-block mt-[1rem]">
                                        <div className="group relative inline-flex max-w-full cursor-pointer items-center justify-start border-none bg-transparent p-0 text-black">
                                            <a href={service.link} className="relative flex items-center justify-start whitespace-nowrap p-[14px_20px] font-dmsans text-[1rem] font-normal leading-[1] text-black no-underline md:px-[1.5rem] md:pb-[0.85rem] md:pt-[0.75rem] md:text-[1.125rem]">
                                                ...
                                                <span className="flex items-center">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.1 15.17" className="ml-[1rem] w-[14px] text-black opacity-100 translate-x-[-3px] md:w-[18px] md:translate-x-[2px]">
